...
230  close(58)
  ...
  subroutine load_dsphs_LikeMap()
    ...
    if (sets__DMdecay) then 
      ...
      dsphs__logJ=(/ 3.2d0,3.3d0,2.9d0,3.6d0,3.5d0,2.9d0,2.8d0,3.2d0,2.2d0,3.2d0,2.2d0,2.8d0,3.7d0,3.3d0,3.5d0 /)
      dsphs__logJerr=(/ 0.3d0,0.6d0,0.1d0,0.5d0,0.2d0,0.1d0,0.4d0,0.3d0,0.7d0,0.1d0,1.1d0,0.1d0,0.5d0,0.1d0,0.6d0 /)
